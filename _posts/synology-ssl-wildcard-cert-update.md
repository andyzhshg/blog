...
![](http://s3.up4dev.com:38080/blog/nas-cert-up/cert-list.png)
...
![解压](http://s3.up4dev.com:38080/blog/nas-cert-up/unzip.png)
...
![配置](http://s3.up4dev.com:38080/blog/nas-cert-up/config.png)
...
![APIKEY](http://s3.up4dev.com:38080/blog/nas-cert-up/apikey.png)
...
![](http://s3.up4dev.com:38080/blog/nas-cert-up/file-info.png)

![](http://s3.up4dev.com:38080/blog/nas-cert-up/file-path.png)
...
![](http://s3.up4dev.com:38080/blog/nas-cert-up/task.png)

设置任务名称和操作用户，需要注意的是这里一定要选择`root`：

![](http://s3.up4dev.com:38080/blog/nas-cert-up/task-name.png)

设置计划的时间和周期，这里只支持按月或者年重复，我们只能取按月重复才能满足 Let's Encrypt 至少3个月更新一次的要求：

![](http://s3.up4dev.com:38080/blog/nas-cert-up/task-inv.png)

设置执行脚本，这里我们将脚本的输出重定向到了一个`log.txt`的文件中，以方便后期查看脚本的执行情况：

![](http://s3.up4dev.com:38080/blog/nas-cert-up/task-cmd.png)
...
![](http://s3.up4dev.com:38080/blog/nas-cert-up/task-run.png)
